...
<template>
  <article
    class="relative flex flex-col rounded-md border transition-colors"
    :class="
      active
  ...
  >
    <button
      class="absolute right-1.5 top-1.5 z-[1] grid size-7 cursor-pointer place-items-center rounded-md text-muted transition-colors hover:bg-surface hover:text-accent-strong focus-visible:outline-2 focus-visible:outline-accent"
      type="button"
    ...
    <button
      class="flex cursor-pointer flex-col gap-1 p-2.5 pr-9 text-left"
      type="button"
